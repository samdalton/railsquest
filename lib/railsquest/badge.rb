...
module Railsquest
  class Badge
    ...
    def verified?
        ...
        RestClient.post 'http://' + contents['hostname'] + ':' + Railsquest.web_port.to_s + '/verify', { :signature => contents['signature'], :quest_name => name, :original_host => Railsquest.host_name } 
    end
